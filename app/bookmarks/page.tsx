          ...
          {orderedPosts.length > 0 ? (
            ...
            {orderedPosts.map((post) => {
              ...
              return (
                <div
                  key={post.id}
                  className="overflow-hidden rounded-xl border-b-8 border-background bg-white last:border-b-0 sm:border sm:border-warm-200 sm:shadow-sm"
                >
                  ...
                  {post.type === "article" && post.body && (
                    <ArticleBody title={post.title} body={post.body} fileUrl={post.file_url} fileType={post.file_type} />
                  )}
