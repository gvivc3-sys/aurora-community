      ...
      <div className="mx-auto max-w-3xl px-3 pb-8 pt-5 sm:px-6 sm:pb-12 sm:pt-6">
        ...
        <div className="mx-auto mt-10 max-w-md">
          ...
          <ul className="mt-4 space-y-3">
            {[
              "The Portal: Ashley's articles, voice notes, and community discussion, organized into Nourishment, Strength Training, Energy, Beauty, and Whisper.",
              "Discussions: open threads with the whole community on anything on your mind.",
